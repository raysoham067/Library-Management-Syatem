...
<head>
	...
	<title>Manage Authors | LMS</title>
...
<body>
	...
	<div class="container mt-3">
		<marquee>📢 Library Management System — Manage all registered authors below.</marquee>
	</div>

	<!-- ✅ Table Section -->
	<div class="container table-container">
		<h4>🖋️ Manage Authors</h4>
		<hr>
						...
						if (mysqli_num_rows($query_run) > 0) {
							while ($row = mysqli_fetch_assoc($query_run)) {
								...
								<tr>
									...
									<td>
										<a href='edit_author.php?aid={$row['author_id']}' class='btn-edit'>Edit</a>
										<a href='delete_author.php?aid={$row['author_id']}' class='btn-delete'>Delete</a>
									</td>
								</tr>";
								$count++;
							}
						} else {
							echo "<tr><td colspan='4' class='text-center text-muted'>No authors found in the database.</td></tr>";
						}
					?>
				</tbody>
			</table>
