<?php
	...
	$query = "
		SELECT books.book_name, books.book_no, books.book_price, authors.author_name
		FROM books
...
<head>
	...
	<title>All Registered Books | LMS</title>
...
<body>
	...
	<div class="container mt-3">
		<marquee>📢 Library opens at 8:00 AM and closes at 8:00 PM | View all registered books below.</marquee>
	</div>

	<!-- ✅ Table Section -->
	<div class="container table-container">
		<h4>📚 Registered Books Details</h4>
		<hr>
				...
				<tbody>
					<?php
						...
						if (mysqli_num_rows($query_run) > 0) {
							...
							echo "<tr><td colspan='5' class='text-center text-muted'>No books found in the database.</td></tr>";
						}
					?>
				</tbody>
			</table>
