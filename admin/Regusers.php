...
<head>
	...
	<title>All Registered Users | LMS</title>
...
<body>
	...
	<div class="container mt-3">
		<marquee>📢 Library Management System — Open from 8:00 AM to 8:00 PM | Manage Registered Users Below</marquee>
	</div>

	<!-- ✅ Table Section -->
	<div class="container table-container">
		<h4>👥 Registered Users Details</h4>
		<hr>
				...
				<tbody>
					<?php
						...
						if (mysqli_num_rows($query_run) > 0) {
							...
							echo "<tr><td colspan='5' class='text-center text-muted'>No registered users found.</td></tr>";
						}
					?>
				</tbody>
			</table>
